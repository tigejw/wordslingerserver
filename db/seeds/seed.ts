...
function createFriends(){
    return db.query(`CREATE TYPE friend_status AS ENUM ("req_from_uid1","req_from_uid2","friend")`)
    .then(()=>{
...
function createWordMasteryTable(){
    return db.query(`CREATE TYPE mastery_level AS ENUM ("beginner","intermediate","master")`)
    .then(()=>{
